...
public class Sorter
{
   ...
   public static void main(String[] args)
   {
      ...
      /*
       * System.out.println("\n//Advanced MergeSort alrgorithm"); int[]
       * testArray5 = { 5, 3, 6, 8, 1, 2, 9, 7, 4, 8, 0 };
       * System.out.println(out(testArray5)); mergeSortAdv(testArray5);
       * System.out.println(out(testArray5));
       */

      System.out.println("\n//CountSort alrgorithm");
      int[] testArray6 = { 5, 3, 6, 8, 1, 9, 7, 4, 8, 0,2 };
      System.out.println(out(testArray6));
      countingSort(testArray6, 11);
      System.out.println(out(testArray6));
   }
