...
public class Dashboard extends JPanel implements ActionListener {
   ...
   public Dashboard() {
      ...
      calendar_1.setPreferredSize(new Dimension(150, 150));
      calendar_1.setBorder(null);
      calendar_1.setBackground(Color.WHITE);
      calendar_1.setBounds(10, 47, 330, 212);
      calendar.add(calendar_1);
